export function AboutSection() {
    return (
        <section id="about" className="bg-linear-to-r from-[#000000] via-[#272727] to-[#494949] p-[50px] flex flex-col justify-between md:flex-row">
            <div className="max-w-[450px]">
                ...
                <div className="w-full md:min-w-[500px] md:p-[10px] md:ml-auto mt-5">
                {/* card 1 */}
